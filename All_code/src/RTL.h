// This is a modified version for completing ECE254 Lab3
//
/*----------------------------------------------------------------------------
 *      RL-ARM - A P I 
 *----------------------------------------------------------------------------
...
#ifdef __BIG_ENDIAN
 #define U32_LE(v) (__rev(v))
 #define U16_LE(v) (__rev(v) >> 16) 
 #define U32_BE(v)       (v)
 #define U16_BE(v)       (v)
#else
 #define U32_BE(v) (__rev(v))
 #define U16_BE(v) (__rev(v) >> 16) 
 #define U32_LE(v)       (v)
 #define U16_LE(v)       (v)
#endif
...
/* Dynamic Memory Flags added for ECE254 lab3 */
#define MEM_NOWAIT 0
#define MEM_WAIT 1

#if !(defined(__TARGET_ARCH_6S_M) || defined(__TARGET_ARCH_7_M) || defined(__TARGET_ARCH_7E_M))
...
/* POSIX Message Queue Management */
...
extern int mq_receive(mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned *msg_prio);
...
#define mq_open(name,oflag) _mq_open((U32)rt_mq_open,name,oflag)
#define mq_close(mqdes) _mq_close((U32)rt_mq_close,mqdes)
...
extern mqd_t _mq_open(U32 p, const char *name, int oflag) 																				__SVC_0;
extern mqd_t _mq_close(U32 p, mqd_t mqdes)																											 	__SVC_0;
extern mqd_t _mq_send(U32 p, mqd_t mqdes, const char *msg_ptr, size_t msg_len, unsigned msg_prio) __SVC_0;
extern mqd_t _mq_receive(U32 p, mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned *msg_prio)		__SVC_0;
...
/* Dynamic Memory Management Functions added by ECE254*/
...
extern void *_os_mem_alloc(U32 p, int size, unsigned char flag)  __SVC_0;
